...
<head>
    ...
    <link rel="stylesheet" href="course11.css">
...
?>
    ...
    <div class="container">
        <h1 style="font-family: sans-serif, Poppins;">iPhone Box Mockup Isometric</h1>
        <div class="row" style="font-family: sans-serif, Poppins;">
            <div class="col">
                <div class="feature-img">
                    ...
                    <iframe width="100%" height="350px" src="https://www.youtube.com/embed/S9Wq5PvKaSk" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div class="col">
                ...
                <div class="small-img-row">
                    <div class="small-img">
                        <a href="course10.php"><img src="image/isometric-text.png" style="margin-top: 4px; margin-left: 4px;"></a>
                    </div>
                    <a href="course10.php" style="text-decoration: none;"><p>3D Isometric Text Effects</p></a>
                </div>
            </div>

            <div class="description" style="margin-top: 10px; margin-bottom: 70px;">
                <h1>Example</h1>
            </div>
    ...
    <!-- Site footer -->
	<footer class="site-footer" style="margin-top: 520px;">
		<div class = "container">
