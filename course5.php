...
?>
    ...
    <div class="container">
        <h1 style="font-family: sans-serif, Poppins;">Animated gradient buttons on hover</h1>
        <div class="row" style="font-family: sans-serif, Poppins;">
            <div class="col">
                <div class="feature-img">
                    ...
                    <iframe width="100%" height="350px" src="https://www.youtube.com/embed/kwrgKJzsgGE" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div class="col">
                <div class="small-img-row">
                    <div class="small-img">
                        <a href="course4.php"><img src="image/text-gradient.png" style="margin-top: 4px; margin-left: 4px;"></a>
                    </div>
                    <a href="course4.php" style="text-decoration: none;"><p>Gradient Text Effect</p></a>
                </div>
                <div class="small-img-row">
                    <div class="small-img">
                        <a href="course6.php"><img src="image/glass-profile.png" style="margin-top: 4px; margin-left: 4px;"></a>
                    </div>
                    <a href="course6.php" style="text-decoration: none;"><p>CSS Glassmorphism Profile Card UI</p></a>
                </div>
                <div class="small-img-row">
                    <div class="small-img">
                        <a href="course7.php"><img src="image/glass-creditcard.png" style="margin-top: 4px; margin-left: 4px;"></a>
                    </div>
                    <a href="course7.php" style="text-decoration: none;"><p>Glass morphism 3D Flip Debit Card UI</p></a>
                </div>
            </div>

            <div class="description" style="margin-top: 10px; margin-bottom: 200px;">
                <h1>Example</h1>
            </div>
