...
<head>
    ...
    <link rel="stylesheet" href="course8.css">
...
?>
    ...
    <div class="container">
        <h1 style="font-family: sans-serif, Poppins;">Neumorphism Loading Animation</h1>
        <div class="row" style="font-family: sans-serif, Poppins;">
            <div class="col">
                <div class="feature-img">
                    ...
                    <iframe width="100%" height="350px" src="https://www.youtube.com/embed/2wL6J7oJbpc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div class="col">
                ...
                <div class="small-img-row">
                    ...
                    <a href="course3.php" style="text-decoration: none;"><p>Neumorphism Loading Animation</p></a>
                </div>
            </div>
